                                ...
                                foreach($productPurchaseDetails as $key => $productPurchaseDetail){
                                    ...
                                    ->leftJoin('product_sale_returns','product_sale_return_details.product_sale_return_id','=','product_sale_returns.id')
                                        ->select(
                                            ...
                                            'product_sale_return_details.product_category_id',
                                            'product_sale_return_details.product_sub_category_id',
                                            'product_sale_return_details.product_brand_id',
                                        ...
                                        ->where('product_sale_return_details.product_category_id',$productPurchaseDetail->product_category_id)
                                        ->where('product_sale_return_details.product_sub_category_id',$productPurchaseDetail->product_sub_category_id)
                                        ->where('product_sale_return_details.product_brand_id',$productPurchaseDetail->product_brand_id)
                                        ->where('product_sale_returns.store_id',$store->id)
                                        ->groupBy('product_sale_return_details.product_id')
                                        ->groupBy('product_sale_return_details.product_category_id')
                                        ->groupBy('product_sale_return_details.product_sub_category_id')
